...
-->
 ...
 <div class="header">
  ...
  <br/>
		   ...
		   <center> <span  class="form_row STYLE2">管理员登录</span></center>
		   <br/>
		  <form name="form1" action="adLoginServlet" method="post"
          onsubmit="return isValidate(form1)">
		  
          用户名:<input type="text" name="username" size="21">
		  <br/>
		  <br/>
          密&nbsp;&nbsp;码:
          <input type="password" name="userpass" size="22"><br/>
          <br/>
  ...
  <br/>
  <br/>
  <p class="details"><img src="images/huangcen.gif" align="right" />&nbsp;本草仁堂(www.bcrt.com) - 专业的药材网上商城,可提供包括中药材、中草药、 滋补药材、药材工具、等数万种药材商品直销,便捷，诚信的服务,为您提供愉悦的网上购物旅程！
