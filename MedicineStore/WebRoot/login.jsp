		...
		<div class="main" id="main">
			<div id="head">
				...
				<div id="left">
					...
					<br>
					<center>
						<span class="form_row STYLE2">用户登陆</span>
					</center>
					<br />
					...
					<form name="form1" action="LoginServlet" method="post"
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="password" name="userpass" size="22">
								</td>
							</tr>
				...
				<div id="right">
					...
					<p class="details">
						...
						滋补药材、药材工具、等数万种药材商品直销,便捷，诚信的服务,为您提供愉悦的网上购物旅程！ 主营产品：鼠曲草 天南星 槐花 白术 玄参
						牵牛子 天花粉 千金子 白芷 蝉蜕 蒲公英 丹参 皂角刺 瓜蒌 合欢花 地骨皮 女贞子 槐角 何首乌.
					</p>
					<br />
