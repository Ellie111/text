...
<html>
  ...
  <body style="text-align:center">
    ...
    抱歉，您还没有购买任何商品！！<br/>
    <a href="${pageContext.request.contextPath}/AllBookServlet">点击此处进入购买页面</a>
     <form action="${pageContext.request.contextPath}/LoginUserInfoServle" method="post"> 
 <tr>
