...
<div id =  "last" style=" width:100%;float:left" >
  <h1 style="font-size:30px; text-align:left" >注册新用户 <span style="font-size:20px">完成手机/邮箱验证注册，可以获得礼品券哦！</span><span style="font-size:20px; float:right">注册帮助</span></h1>
...
<form id="form1" name="form2" method="post" action="registerHandler.jsp" onsubmit="return CheckSubmit()">
  ...
  <tr>
    ...
    <tr>
      <td>密码:</td>
      <td >
      <input name="password" type="password" id="TextPwd" onblur="CheckPwd()"/>
      </td>
    ...
    <tr>
      <td >手机号:</td>
      <td >
      <input name="tel" type="text" id="TextTel"onblur="CheckTel()" />
      </td>
     ...
     <tr>
      <td >邮箱:</td>
      <td >
      <input name="email" type="text" id="TextEmail"onblur="CheckEmail()" />
      </td>
