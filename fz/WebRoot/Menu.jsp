...
<body style="overflow:hidden ">
			...
			<td height="29" background="./image/top_m.gif">
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td class="top1" onClick="got(1);" id="ttd1" >
						<a href="system/index.jsp" target="midFrame">系统管理</a>
					</td> 
					<td><img src="./image/top_line.gif" width="2" height="29"></td>
					<td class="top1" onClick="got(8);" id="ttd8">
						<a href="stock/index.htm" target="midFrame">库存管理</a>
					</td>					
					<td><img src="./image/top_line.gif" width="2" height="29"></td>
					<td class="top1" onClick="got(10);" id="ttd10">
    ...
    <map name="Map">
      ...
      <area shape="rect" coords="68,3,127,25" href="login.html" target="_parent">
</map>
</body>
</html>
